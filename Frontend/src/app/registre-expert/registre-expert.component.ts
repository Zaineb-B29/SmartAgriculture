...
@Component({
  selector: 'app-registre-expert',
  templateUrl: './registre-expert.component.html',
  styleUrls: ['./registre-expert.component.css']
})
export class RegistreExpertComponent {
  ...
  addNewExpert() {
    ...
    console.log('expert à envoyer:', expert);
